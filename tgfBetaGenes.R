...
tgfbgenes_genes <- read.csv('/Users/sm2949/Desktop/bulkRNAdata/GSEA_KEGG_TGF_BETA_SIGNALING_PATHWAY.txt', col.names = 'genes')
...
ggplot(df, aes(x = logFC, y = neglogP)) +
  ...
  labs(
    title = "4.5dpa Regen vs. Control KEGG TGF-B Signaling Pathway Genes",
    x = "log2 Fold Change",
    y = "-log10(P-Value)"
  )
